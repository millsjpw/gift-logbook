...
export type ExchangeParticipantResponse = Omit<
  ExchangeParticipant,
  "createdAt" | "updatedAt"
> & { personName: string };
...
export const exchangeAssignments = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("exchange_assignment_unique").on(
      table.exchangeId,
      table.round,
      table.giverId,
    ),

    uniqueIndex("exchange_receiver_unique").on(
      table.exchangeId,
      table.round,
      table.receiverId,
    ),
...
export type ExchangeAssignmentResponse = Omit<
  ExchangeAssignment,
  "createdAt" | "updatedAt" | "round"
> & { giverName: string; receiverName: string };
